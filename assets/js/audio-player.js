...
class AudioPlayerHandlerClass extends elementorModules.frontend.handlers.Base {
  ...
  playTrack(e) {
    ...
    this.elements.$source[0].setAttribute('src', "/wp-content/uploads/".concat(track));
...
jQuery(window).on('elementor/frontend/init', () => {
  ...
  elementorFrontend.hooks.addAction('frontend/element_ready/audio_player.default', addHandler);
});